### Executar esse app via terminal com o comando: streamlit run streamlit_cpf.py
        ...
        if st.button("Processar"):
            ...
            if feature_choice == "DetectTexto":
                try:
                    ...
                    d = pytesseract.image_to_data(new_img, output_type=Output.DICT, lang='por')
                    n_boxes = len(d['level'])
                    ...
                    st.info("Erro: Selecionar um arquivo válido")
